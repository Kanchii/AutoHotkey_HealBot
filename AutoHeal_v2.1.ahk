...
Gui Principal: Add, ComboBox, x205 y73 w136 +Disabled vcbxSource1, Life||Mana
...
Gui Principal: Add, ComboBox, x205 y110 w136 +Disabled vcbxSource2, Life||Mana
Gui Principal: Add, Text, x162 y147 w40 h23 +Disabled +0x200 vtxtSource3, Source:
Gui Principal: Add, ComboBox, x205 y147 w136 +Disabled vcbxSource3, Life||Mana
...
Gui Principal: Add, Text, x300 y73 w70 h23, Auto Fishing:
Gui Principal: Add, Button, x370 y55 w70 h23 gSetaFishingRod, Fishing Rod
Gui Principal: Add, Button, x370 y85 w70 h23 gSetaWater, Water
Gui Principal: Add, Button, x450 y73 w55 h20 vbtn_AutoFishing gclickAutoFishing +Disabled, Start
Gui Principal: Add, CheckBox, x300 y125 w15 h23 vcheckAutoFood gCheckAutoFood
Gui Principal: Add, Text, x322 y130 w65 h23 +Disabled vtxtAutoFood, Auto Food:
Gui Principal: Add, ComboBox, x392 y125 w55 +Disabled +Uppercase vcbxKeyAutoFood, F1|F2|F3|F4|F5|F6|F7|F8|F9|F10|F11|F12
...
run:
    ...
    if(Check1 = 1){
        ...
        life1 := % edtLife1
        x_pos := min_x + ((max_x - min_x) * life1) / 100.0
        x_pos_mana := min_x_mana + ((max_x_mana - min_x_mana) * life1) / 100.0
        ;y_pos := y_med
        GuiControlGet, source1, Principal:, cbxSource1
        if(source1 = "Life"){
            PixelGetColor, lifeColor, x_pos, y_med, RGB
        } else if(source1 = "Mana"){
            PixelGetColor, lifeColor, x_pos_mana, y_med_mana, RGB
        } 
    ...
    if(Check2 = 1){
        ...
        x_pos_mana := min_x_mana + ((max_x_mana - min_x_mana) * life2) / 100.0
    ...
    if(Check3 = 1){
        ...
        x_pos_mana := min_x_mana + ((max_x_mana - min_x_mana) * life3) / 100.0
